package com.thn.tishuashua.sentinel;
...
public class SentinelRulesManager {
    ...
    public void initFlowRules() {
        // 单 IP 查看题目列表限流规则
        ParamFlowRule rule = new ParamFlowRule(Sentinel_List_Question_VO_By_Page)
    ...
    public void initDegradeRules() {
        // 单 IP 查看题目列表熔断规则
        DegradeRule slowCallRule = new DegradeRule(Sentinel_List_Question_VO_By_Page)
        ...
        DegradeRule errorRateRule = new DegradeRule(Sentinel_List_Question_VO_By_Page)
